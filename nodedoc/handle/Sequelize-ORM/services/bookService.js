const { bookCreateVis, bookDeleteVis, bookUpdateVis } = require('./optionValids/bookValid.js');
...
exports.create = async function (obj) {
	// 获取对象指定属性
	const data = pick(obj, 'name', 'imgurl', 'publishDate', 'author', 'description');
...
exports.findByPage = async function (searchObj) {
	...
	const where = {};
	const findObj = {
		attributes: ['id', 'name', 'imgurl', 'publishDate', 'author', 'description'],
		offset: (page - 1) * limit,
		limit: limit
	};
...
exports.update = async function (updateObj, id) {
	const data = pick(updateObj, 'name', 'name', 'imgurl', 'publishDate', 'author', 'description');
